package com.sdkj.bbcat.widget.TimeDateSelectView.wheel;
...
public class DateObject extends Object{
	 ...
	 * @param data
	 */
	public DateObject(int type,int data){
		switch (type){
			case 1:
				this.year=data;
			...
			case 2:
				if(data > 12)
					...
					this.month = data;
				this.listItem =  String.format("%02d", this.month);
				break;
			case 3:
				this.day=data;
				this.listItem=String.format("%02d", this.day);
				break;
			default:
				break;
		}
