...
//                        acceptInvitation(holder.status, msg);
    ...
    private void agree(final Button button, final InviteMessage msg) {
        PostParams params = new PostParams();
        params.put("phone", msg.getFrom());
        HttpUtils.postJSONObject((BaseActivity) context, Const.SAVE_FRIENDS, SimpleUtils.buildUrl((NewFriendsMsgActivity) context, params), new RespJSONObjectListener((NewFriendsMsgActivity) context) {
...
//                if (respVo.isSuccess()) {
                    ...
                    CommunityPage.ConnectEvent event = new CommunityPage.ConnectEvent(4);
