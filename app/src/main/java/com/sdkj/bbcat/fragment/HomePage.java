                    ...
                    if (!Utils.isEmpty(homeVo.getNews())) {
                        ...
                        tv_recommend_more.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                activity.toast("推荐更多" + category0.getCategory_id());
                            }
                        });
                        for (NewsVo newsVo : category0.getCategory_list()) {
                        ...
                        tv_diary_more.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                activity.toast("日记更多" + category1.getCategory_id());
                            }
                        });
                        for (NewsVo newsVo : category1.getCategory_list()) {
                        ...
                        tv_doctor_more.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                activity.toast("医院更多" + category2.getCategory_id());
                            }
                        });
                        ...
                        tv_knowledge_more.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                activity.toast("育儿更多" + category3.getCategory_id());
                            }
                        });
                        for (NewsVo newsVo : category3.getCategory_list()) {
                            View view = activity.makeView(R.layout.item_recommend);
                            ImageView iv_image = (ImageView) view.findViewById(R.id.iv_image);
                            TextView tv_title = (TextView) view.findViewById(R.id.tv_title);
                            TextView tv_come_form = (TextView) view.findViewById(R.id.tv_come_form);
                        ...
                        tv_my_circle.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                activity.toast("我圈更多" + category4.getCategory_id());
                            }
                        });
                        for (NewsVo newsVo : category4.getCategory_list()) {
                            View view = activity.makeView(R.layout.item_recommend);
                            ImageView iv_image = (ImageView) view.findViewById(R.id.iv_image);
                            TextView tv_title = (TextView) view.findViewById(R.id.tv_title);
                            TextView tv_come_form = (TextView) view.findViewById(R.id.tv_come_form);
                        ...
                        tv_guess.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                activity.toast("喜欢更多" + category5.getCategory_id());
                            }
                        });
                        for (NewsVo newsVo : category5.getCategory_list()) {
                            View view = activity.makeView(R.layout.item_recommend);
                            ImageView iv_image = (ImageView) view.findViewById(R.id.iv_image);
                            TextView tv_title = (TextView) view.findViewById(R.id.tv_title);
                            TextView tv_come_form = (TextView) view.findViewById(R.id.tv_come_form);
